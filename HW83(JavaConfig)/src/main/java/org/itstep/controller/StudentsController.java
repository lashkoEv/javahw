...
public class StudentsController {
    ...
    public String register(@Validated @ModelAttribute StudentDto studentDto,
        ...
        emptyContext.setAuthentication(new UsernamePasswordAuthenticationToken(studentDto, studentDto.getPassword(),
                AuthorityUtils.createAuthorityList(studentDto.getRole())));
