...
public class AcademyService {
    ...
    public List<TeacherDto> getAllTeacherDto() {
        return teacherRepository.findAll()
                .stream()
                .map(teacher -> new TeacherDto(teacher.getId(), teacher.getFirstName(), teacher.getLastName(), teacher.getStartWork(), teacher.getGroups()
                        .stream()
                        .map(Group::getName)
    ...
    public void save(TeacherDto teacherDto) {
        ...
        save(new Teacher(teacherDto.getFirstName(), teacherDto.getLastName(), teacherDto.getStartWork(), groupSet));
    }
