    ...
    <div class="row">
        <form:form modelAttribute="student" class="col s12" method="post">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        <form:label path="role">President</form:label>
                        <form:checkbox path="role" cssStyle="opacity: 1; margin-top: 17px; pointer-events: auto" value="president" class="validate"/>
                        <form:errors path="role"  class="error-text helper-text" data-error="wrong" data-success="right"/>
                    </div>
                </div>
            </div>
            <div class="row">
