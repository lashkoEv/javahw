    ...
    public String index(Model model,
        ...
        if ((firstName == null && lastName == null) || ("".equals(firstName) && "".equals(lastName))) {
            ...
            if ("".equals(firstName) || "".equals(lastName)) {
                model.addAttribute("teachersDto", academyService.findTeachersByFirstOrLastName(firstName, lastName));
            } else {
                model.addAttribute("teachersDto", academyService.findTeachersByFirstAndLastName(firstName, lastName));
            }
        }
